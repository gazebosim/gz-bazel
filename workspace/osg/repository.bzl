...
def _impl(repository_ctx):
    ...
    if os_result.is_ubuntu:
        ...
        repository_ctx.symlink("/usr/include/osgManipulator", "include/osgManipulator")  # noqa
        repository_ctx.symlink("/usr/include/osgParticle", "include/osgParticle")  # noqa
        repository_ctx.symlink("/usr/include/osgPresentation", "include/osgPresentation")  # noqa
        repository_ctx.symlink("/usr/include/osgShadow", "include/osgShadow")
        repository_ctx.symlink("/usr/include/osgSim", "include/osgSim")
        repository_ctx.symlink("/usr/include/osgTerrain", "include/osgTerrain")  # noqa
