...
load("@gz//bazel/workspace:execute.bzl", "path", "which")
load("@gz//bazel/workspace:os.bzl", "determine_os")

_DEFAULT_TEMPLATE = Label("@gz//bazel/workspace:pkg_config.BUILD.tpl")
...
Example:
    WORKSPACE:
        load("@drake//bazel/workspace:pkg_config.bzl", "pkg_config_repository")
