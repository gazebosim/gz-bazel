load("@ignition//tools/skylark:ignition_py.bzl", "py_test_isolated")
...
def _bazel_lint(name, files, ignore):
    if files:
        ...
        py_test_isolated(
            ...
            size = "small",
            srcs = ["@ignition//tools/lint:bzlcodestyle"],
            data = files,
            args = ignores_as_arg + locations,
            main = "@ignition//tools/lint:bzlcodestyle.py",
        ...
        py_test_isolated(
            ...
            size = "small",
            srcs = ["@ignition//tools/lint:buildifier"],
            data = files,
            args = ["-mode=check"] + locations,
            main = "@ignition//tools/lint:buildifier.py",
